...
\end{Verbatim}
    ...
    \item \textbf{Remove current wpa\_supplicant config to avoid problems:}
\begin{Verbatim}[commandchars=\\\{\}]
...
exec amixer set Headphone 100%
exec amixer set Headphone unmute
exec amixer set Speaker 100%
exec amixer set Speaker unmute
