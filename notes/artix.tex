...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(chroot) root#} [\textcolor{command}{yes} |] \textcolor{command}{pacman} -S dhcpcd dhcpcd-dinit wpa_supplicant
...
\end{Verbatim}
    \item \textbf{Create doas config file:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{touch} \textcolor{file}{/etc/doas.conf}
\end{Verbatim}
...
\section{Locales}
\begin{enumerate}
    \item \textbf{Print current locales:}
\begin{Verbatim}[commandchars=\\\{\}]
...
Dracut initramfs will include keymap and font on regeneration!
\begin{itemize}
    \item \textbf{Keymap:}
    \begin{enumerate}
