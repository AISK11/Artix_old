...
menuentry "Artix" \{
    #volume  "Arch Linux"
    icon    refind/themes/refind-theme/icons/128-48/os_artix.png
    loader  /linuces/artix/vmlinuz-linux
    options "initrd=/linuces/intel-ucode.img \char92
    initrd=/linuces/intel-ucode.img rw root=/dev/mapper/luks-root quiet"
    #disabled
\}
\end{Verbatim}
