...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(chroot) root#} \textcolor{command}{mkdir} -p <\textcolor{dir}{/boot/EFI/BOOT/}> <\textcolor{dir}{/boot/EFI/linuces/artix/}>
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(chroot) root#} \textcolor{command}{mv} \textcolor{file}{/boot/intel-ucode.img} <\textcolor{dir}{/boot/EFI/linuces/}>
\end{Verbatim}
    \item \textbf{Move kernel to linux directory:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(chroot) root#} \textcolor{command}{mv} \textcolor{file}{/boot/vmlinuz-linux} <\textcolor{dir}{/boot/EFI/linuces/artix/}>
\end{Verbatim}
\end{enumerate}
\subsection{Dracut}
\begin{enumerate}
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(chroot) root#} \textcolor{command}{file} <\textcolor{file}{/boot/EFI/linuces/artix/vmlinuz-linux}>
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(chroot) root#} \textcolor{command}{dracut} -f <\textcolor{file}{/boot/EFI/linuces/artix/initramfs-linux.img}>
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(chroot) root#} \textcolor{command}{cp} \textcolor{file}{/usr/share/refind/refind_x64.efi} <\textcolor{file}{/boot/EFI/BOOT/BOOTX64.EFI}>
\end{Verbatim}
...
-l <\textcolor{file}{/EFI/BOOT/BOOTX64.EFI}> -L <"rEFInd"> -v
\end{Verbatim}
...
menuentry "Artix" \{
    #volume  "Arch Linux"
    icon    themes/refind-theme/icons/128-48/os_artix.png
    loader  /EFI/linuces/artix/vmlinuz-linux
    options "initrd=/EFI/linuces/intel-ucode.img \char92
    initrd=/EFI/linuces/artix/initramfs-linux.img \char92
